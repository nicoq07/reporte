...
function procesarDat($ruta, $days)
{
...
function agruparDiasLegajos($legajos, $array_lineas)
{
    $arrayAux = null;
...
function agruparDiasHoras($legajos, $diasTrabajados, $arrayOrdenado, $days)
{
    $arrayAux = null;
...
function crearReporte($ruta, $days)
{
...
function ordenarPorDia(array $array)
{
    $arrayOrdenado = null;
...
function orderListByValue(array $list)
{
...
function groupListByDate(array $list)
{
    $arrayAgrupado = null;
    for ($i = 1; $i < count($list); $i ++) {
